...
if __name__ == '__main__':
    ...
    for source in nodelist:
        c=0
        os.system('docker cp '+source+':/address.csv  /home/titanium/Kriptosare.gen/backupwallet/address.csv') 
        with open('/home/titanium/Kriptosare.gen/backupwallet/address.csv') as my_file:
            c=sum(1 for _ in my_file)
        print(str(source)+": "+str(c)+" addresses")
        os.system('rm /home/titanium/Kriptosare.gen/backupwallet/address.csv') 
