...
mysqlimport --fields-terminated-by=, --columns='tx_rec,amount_rec,tx_sent,amount_sent,balance,uniques,sibling' --local -uvicom -pvicom db /root/behaviour/pool/synthetic.csv
